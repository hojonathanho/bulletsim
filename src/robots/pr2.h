...
private:
    ...
    void actionWrapper(TimedAction::Ptr a, float dt) {
        a->reset();
...
public:
    ...
    void setHapticCb(HapticEvent h, TimedAction::Ptr a, float dt) { setHapticCb(h, boost::bind(&PR2Manager::actionWrapper, this, a, dt));}
