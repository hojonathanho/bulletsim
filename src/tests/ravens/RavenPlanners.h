...
#ifndef __RAVEN_PLANNERS_H__
#define __RAVEN_PLANNERS_H__
...
/**
 * Note : The classes below are for planning for Raven Arms only.
...
public:
	...
	/** _robot :  is the robot[ravens] for which we want to plan.
	 *  RAVE :  The rave instance in which we wish to plan.
	 *  SIDE :  specifies which arm to plan for:  if 'l' : left else, right.*/
	EndTransformPlanner(RaveRobotObject::Ptr _robot, RaveInstance::Ptr _rave, char side='l');
...
public:
	 ...
	 *  RAVE   :  The rave instance in which we wish to plan.
	 *  SIDE   :  specifies which arm to plan for:  if 'l' : left else, right.*/
	WayPointsPlanner(RaveRobotObject::Ptr _robot,
...
public:
	...
	/** _RAVENS :  is the manager of the robot.
	 *  SIDE    :  specifies which arm to plan for:  if 'l' : left else, right.*/
	IKInterpolationPlanner(Ravens &_ravens, RaveInstance::Ptr _rave, char side='l');
