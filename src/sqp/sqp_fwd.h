...
class SignedContact;
typedef boost::shared_ptr<SignedContact> SignedContactPtr;
class DynSolver;
typedef boost::shared_ptr<DynSolver> DynSolverPtr;
class IntegrationConstraint;
typedef boost::shared_ptr<IntegrationConstraint> IntegrationConstraintPtr;
class ForcePenalty;
typedef boost::shared_ptr<ForcePenalty> ForcePenaltyPtr;
class ComplementarityCost;
typedef boost::shared_ptr<ComplementarityCost> ComplementarityCostPtr;
class FrictionConstraint;
typedef boost::shared_ptr<FrictionConstraint> FrictionConstraintPtr;
class OverlapPenalty;
typedef boost::shared_ptr<OverlapPenalty> OverlapPenaltyPtr;
class OverlapConstraint;
typedef boost::shared_ptr<OverlapConstraint> OverlapConstraintPtr;
class TangentMotion;
typedef boost::shared_ptr<TangentMotion> TangentMotionPtr;
class DynErrCost;
...
typedef boost::shared_ptr<CollisionCollector> CollisionCollectorPtr;
