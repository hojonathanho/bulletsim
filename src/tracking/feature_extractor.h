...
public:
	...
	// The children of this class are responsible for updating m_features before this is called
	// Returns the sub-matrix of m_features that contain the feature fType.
